...
- **Input responsiveness disparity** — wired and Bluetooth keyboard inputs are polled via UART FIFO and respond nearly instantly, while the PmodKYPD and Basys3 buttons/switches rely on slower GPIO polling with edge detection. For the best experience, assigning both players to keyboard inputs (wired or BT2) is recommended.​​​​​​​​​​​​​​​​